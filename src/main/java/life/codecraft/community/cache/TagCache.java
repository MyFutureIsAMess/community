package life.codecraft.community.cache;

import life.codecraft.community.dto.TagDTO;
...
public class TagCache {
    public static List<TagDTO> get() {
        ...
        program.setTags(Arrays.asList("js", "php", "css", "html", "java", "node", "python",
                "javascript", "c++", "c", "golang", "objective-c", "typescript", "shell", "swift", "c#",
                "sass", "ruby", "bash", "less", "asp.net", "lua", "scala", "coffeescript", "actionscript"
                , "rust", "erlang", "perl"));
        tagDTOS.add(program);

        TagDTO framework = new TagDTO();
        framework.setCategoryName("平台框架");
        framework.setTags(Arrays.asList("laravel", "spring", "express", "django", "flask", "yii", "ruby" +
        ...
        tool.setTags(Arrays.asList("git", "github", "visual-studio-code", "vim", "sublime-text",
                "xcode", "intellij-idea", "eclipse", "maven", "ide", "svn", "visual-studio", "atom",
                "emacs", "textmate", "hg"));
        tagDTOS.add(tool);
        return tagDTOS;
    }
