...
import life.codecraft.community.dto.CommentCreateDTO;
import life.codecraft.community.dto.CommentDTO;
import life.codecraft.community.dto.ResultDTO;
...
public class CommentController {
    ...
    public Object post(@RequestBody CommentCreateDTO commentCreateDTO,
        ...
        commentSerivce.insert(comment, user);
    ...
    public ResultDTO<List<CommentDTO>> comments(@PathVariable(name = "id") Long id) {
        List<CommentDTO> commentDTOS = commentSerivce.listByTargetId(id, CommentTypeEnum.COMMENT);
